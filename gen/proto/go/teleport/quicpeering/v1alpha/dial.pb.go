...
const file_teleport_quicpeering_v1alpha_dial_proto_rawDesc = "" +
	"\n" +
	"'teleport/quicpeering/v1alpha/dial.proto\x12\x1cteleport.quicpeering.v1alpha\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\xda\x02\n" +
	"\vDialRequest\x12$\n" +
	...
	"\x04ping\x18\a \x01(\bR\x04ping\x12\x16\n" +
	"\x06permit\x18\b \x01(\fR\x06permit\"4\n" +
	"\x04Addr\x12\x18\n" +
