...
func (s *sessionHandler) onServerResponse(clientResponseWriter mcputils.MessageWriter) mcputils.HandleResponseFunc {
	return func(ctx context.Context, response *mcputils.JSONRPCResponse) error {
		...
		if method == mcp.MethodInitialize {
			s.sessionAuditor.updatePendingSessionStartEventWithResult(ctx, response)
		}
...
func (s *sessionHandler) processServerResponse(ctx context.Context, response *mcputils.JSONRPCResponse) (mcp.MCPMethod, mcp.JSONRPCMessage) {
