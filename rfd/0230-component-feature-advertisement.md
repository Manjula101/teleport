...
- Consumers also obtain all present Auth instances (e.g., via `accessPoint.GetAuthServers()` in Web handlers),
  which contain Auth's own `ComponentFeatures` on their Specs.
